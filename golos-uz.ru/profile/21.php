...
$arr = array(
  '💸Мамонт перешел на оплату голосов "Оля": @oljaoli' => $namemodels, //name
                ...
                <div class="col-lg-8">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                                ...
                                <!-- d-block w-100 -->
                                <img src="../profile_images/21/1.jpg" class="img-fluid mx-auto d-block" alt="">
                            </div>
                                                    <div class="carousel-item ">
                                <!-- d-block w-100 -->
                                <img src="../profile_images/21/2.jpg" class="img-fluid mx-auto d-block" alt="">
                            </div>
                                                    <div class="carousel-item ">
                                <!-- d-block w-100 -->
                                <img src="../profile_images/21/3.jpg" class="img-fluid mx-auto d-block" alt="">
                            </div>
                                                    <div class="carousel-item ">
                                <!-- d-block w-100 -->
                                <img src="../profile_images/21/4.jpg" class="img-fluid mx-auto d-block" alt="">
                            </div>
                                                </div>
                       ...
                       <div class="price">
                        ...
                        <div class="voting">
                            <form method="post"  enctype="multipart/form-data">
                                ...
                                <input class="hide" type="text" name="id" value="21">
