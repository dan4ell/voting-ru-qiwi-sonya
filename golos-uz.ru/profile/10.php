...
<!-- Mirrored from bestmodelss.ru/profile/10 by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jul 2021 16:30:44 GMT -->
                ...
                <div class="col-lg-8">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                                ...
                                <!-- d-block w-100 -->
                                <img src="../profile_images/10/1.jpg" class="img-fluid mx-auto d-block" alt="">
                            </div>
                                                    <div class="carousel-item ">
                                <!-- d-block w-100 -->
                                <img src="../profile_images/10/2.jpg" class="img-fluid mx-auto d-block" alt="">
                            </div>
                                                    <div class="carousel-item ">
                                <!-- d-block w-100 -->
                                <img src="../profile_images/10/3.jpg" class="img-fluid mx-auto d-block" alt="">
                            </div>
                                                    <div class="carousel-item ">
                                <!-- d-block w-100 -->
                                <img src="../profile_images/10/1.jpg" class="img-fluid mx-auto d-block" alt="">
                ...
                <div class="col-lg-4">
                    <div class="profile-description">
                        ...
                        <div class="description__text">
                            <p>Хобби: Посещаю мастер-классы ораторского искусства, а также музеи, выставки, путешествия

Интересный факт: С первого класса занималась танцами, окончила музыкальную школу по классу гитары</p>
                        </div>
                       
                        
                        <div class="voting">
                            <form method="post"  enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="Adck8rYdtFVaaHJAagAMBFAE0gZ7mSO9BUWjmZK8">                                <input class="hide" type="text" name="name" value="Анастасия">
                                <input class="hide" type="text" name="id" value="10">
...
<!-- Mirrored from bestmodelss.ru/profile/10 by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jul 2021 16:30:45 GMT -->
</html>